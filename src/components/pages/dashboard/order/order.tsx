...
export default function OrderPage() {
  ...
  const handleChange = (e: ChangeEvent<HTMLSelectElement>) => {
    ...
    setOrders([...res?.data].filter((order) => order?.status?.name === value));
    }
    else {
      setOrders(res?.data);
  ...
  return (
    <div className="content-wrapper">
      ...
      {orders.length > 0 ?   <div className="col-12 grid-margin">
        <div className="card">
                      ...
                      <tr className="cursor-pointer">
                        ...
                        <td>
                          <Tippy
                            ...
                            interactive={true}
                            content={
                              order?.status?.name !== ORDER_STATUS.CANCELED ? (
      ...
      </div>: <h3 className="text-center">Hiện chưa có đơn hàng mà bạn muốn tìm.</h3>}
